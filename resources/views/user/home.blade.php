        ...
        <div class="container my-4" id="katalog">
            ...
            <div style="width: 300%;">
                <div class="d-flex overflow-hidden" id="sliderWrapper"
                    style="width: 90%; height: 100%; transition: transform 0.5s ease-in-out;">
...
>>>>>>> 5fd41fa4e4523e2806d6d838a3c9c8e7f5acdd8b
        ...
        <script>
            ...
            nextButton.addEventListener('click', () => {
                ...
                sliderWrapper.style.transform = `translateX(-${currentSlide * 58}%)`;
            });
        </script>
                                ...
                                <div class="col-md-6 mb-1">
                                    <div class="card card-button card-default mb-4">
                                        ...
                                        <div class="card-footer"
                                            style="border-top: 10px; background-color:rgb(255, 60, 0)">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 text-md-end"
                                                    style="background-color:rgb(255, 60, 0)">
